...
public class Ejemplo043 {
    ...
    public static void main(String[] args) {
        ...
        /*
        En este codigo se suman los valores de los arreglos presentados 
        en valores1 y valores2, la suma se realiza de acuerdo a la posicion 
        dictada por el indice 
        */
    }
